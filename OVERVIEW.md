Listed directory LearnioX
Listed directory docs
Listed directory platform
Listed directory apps
Viewed .md:1-200
Viewed .md:201-450
Viewed 01-Plan-v1.md:1-250
Viewed PHASE.md:1-250
Viewed 02-Service-and-endpoints.md:1-150
Viewed docker-compose.yml:1-139
Listed directory server-service
Listed directory app
Listed directory api
Listed directory v1
Listed directory endpoints
Listed directory models
Viewed __init__.py:1-100
Listed directory api-gateway
Listed directory app
Listed directory router
Listed directory registry
Viewed routes.py:1-54
Listed directory ai-service
Listed directory marketing-service
Listed directory src
Listed directory app
Listed directory auth
Listed directory dashboard
Listed directory courses
Listed directory institution
...
Listed directory conf.d
Viewed default.conf:1-79
Listed directory versions
Listed directory alembic
Viewed ARCHITECTURE_FLOWCHARTS.md:1-150
Viewed 04-files.md:1-100
...
Viewed .env.example:1-66
Viewed router.py:1-64
Viewed page.tsx:1-100
